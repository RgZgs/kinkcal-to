...
export default function SubmitPage() {
  ...
  return (
    <main className="max-w-lg mx-auto px-4 py-8">
      ...
      <form action="/api/submit" method="POST" className="space-y-4" id="submit-form">
        <div>
          ...
          <input
            ...
            placeholder="e.g., Pup Mosh at The Eagle"
          />
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            rows={3}
            className="input-field"
            placeholder="What&apos;s happening? Dress code? Cover charge?"
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            name="venue"
            className="input-field"
            placeholder="e.g., The Black Eagle"
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            name="address"
            className="input-field"
            placeholder="e.g., 718 Queen St W, Toronto"
          />
        </div>
        ...
        <div>
          <label className="block text-sm font-medium text-zinc-300 mb-3">
            Categories * <span className="text-zinc-500">(pick all that apply)</span>
          </label>
          <div className="flex flex-wrap gap-2">
            {categories.map((cat: any) => (
              <label
                key={cat.slug}
                className="category-pill cursor-pointer border transition-all select-none hover:brightness-125"
                style={{
